...
public class Tokenizer {
	...
	public void getTokens(String filePath) throws FileNotFoundException {
	...
	public List<List<String>> getSentences(String filePath)
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		new Tokenizer().getTokens(filePath);
	}
